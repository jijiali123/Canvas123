...
// .wrangler/tmp/bundle-L4TtgC/checked-fetch.js
...
// .wrangler/tmp/bundle-L4TtgC/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-L4TtgC/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-L4TtgC/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
var rewriteError = /* @__PURE__ */ __name((error) => {
...
_LifecycleWatcher_expectedLifecycle = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_frameManager = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_frame = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_timeout = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_navigationRequest = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_eventListeners = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_initialLoaderId = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_sameDocumentNavigationCompleteCallback = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_sameDocumentNavigationPromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_lifecycleCallback = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_lifecyclePromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_newDocumentNavigationCompleteCallback = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_newDocumentNavigationPromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_terminationCallback = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_terminationPromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_timeoutPromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_maximumTimer = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_hasSameDocumentNavigation = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_swapped = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_navigationResponseReceived = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_instances = /* @__PURE__ */ new WeakSet(), _LifecycleWatcher_onRequest = /* @__PURE__ */ __name(function _LifecycleWatcher_onRequest2(request) {
  ...
  __classPrivateFieldGet10(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_checkLifecycleComplete).call(this);
}, "_LifecycleWatcher_onFrameDetached"), _LifecycleWatcher_terminate = /* @__PURE__ */ __name(function _LifecycleWatcher_terminate2(error) {
...
/* @__PURE__ */ __name(async function _Page_setTransparentBackgroundColor2() {
  ...
  const history = await __classPrivateFieldGet23(this, _Page_client, "f").send("Page.getNavigationHistory");
...
var { connect, launch } = puppeteer;

// src/index.ts
import { WorkflowEntrypoint } from "cloudflare:workers";
var MODEL_ID = "@cf/meta/llama-3.1-8b-instruct";
var SYSTEM_PROMPT = "You are a multi-capable AI Agent. You have access to Web Browsing, SQL Databases, KV Storage, Vector Search, and Image Processing.";
...
var AgentTools = {
  ...
  async browse(env, url) {
    const browser = await puppeteer_core_default.launch(env.MYBROWSER);
    const page = await browser.newPage();
    await page.goto(url);
  ...
  async applyWatermark(env, image, watermark) {
    return await env.IMAGES.input(image).draw(env.IMAGES.input(watermark).transform({ width: 32, height: 32 }), { bottom: 32, right: 32 }).response();
  }
};
var MasterWorkflow = class extends WorkflowEntrypoint {
...
__name(MasterWorkflow, "MasterWorkflow");
var AgentState = class extends DurableObject {
  constructor(ctx, env) {
    super(ctx, env);
  }
  async handleState() {
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (url.pathname === "/admin/save" && request.method === "POST") {
        ...
        if (modelId)
          await env.KV.put("CONFIG_MODEL_ID", modelId);
        if (systemPrompt)
          await env.KV.put("CONFIG_SYSTEM_PROMPT", systemPrompt);
